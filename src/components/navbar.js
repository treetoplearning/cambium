    ...
    <nav className="font-mono bg-transparent">
          ...
          <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-end">
            <div className="hidden sm:block sm:ml-6">
              <div className="flex">
                ...
                <a href="https://app.treetoplearning.org" className="px-4 py-2 ml-4 text-sm text-base font-medium leading-5 transition duration-150 ease-in-out rounded-lg hover:text-white hover:bg-green-700 focus:outline-none focus:text-white focus:bg-green-700">Register</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={isOpen ? "block" : "hidden"}>
        <div className="px-2 pt-2 pb-3">
          ...
          <a href="https://app.treetoplearning.org" className="block px-4 py-2 mt-1 text-base font-medium text-gray-300 transition duration-150 ease-in-out rounded-lg hover:text-white hover:bg-green-700 focus:outline-none focus:text-white focus:bg-green-700">Register</a>
        </div>
      </div>
    </nav>
  )
